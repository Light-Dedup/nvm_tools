...
sudo fio -filename=/mnt/pmem/test1 -direct=1 -iodepth 1 -rw=write -ioengine=sync -bs=4K -thread -numjobs=1 -size=128G -name=randrw --dedupe_percentage=0 -group_reporting
